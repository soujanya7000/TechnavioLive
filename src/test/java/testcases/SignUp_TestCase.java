...
public class SignUp_TestCase extends BaseClass {
	...
	/*@BeforeTest
	public void sartReport() throws IOException {
		extentTest = onStart().startTest(sTestCaseName);
		extentTest = extent.startTest("validationForSignup");
	}*/
	...
	public void validationForInviteUser() throws Exception {
		...
		{
			if(actualUser.equalsIgnoreCase(getFremiuminviteUserName())&&actualEmail.equalsIgnoreCase(getFremiuminviteEmail()))
			{
